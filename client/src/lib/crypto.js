...
/**
 * Generate a cryptographically secure random token (CSPRNG)
 */
export function generateSecureToken(prefix = '') {
  ...
  return prefix ? `${prefix}_${randomPart}${timePart}` : `${randomPart}${timePart}`;
}
